...
class DPT_DINOv2(nn.Module):
    def __init__(self, encoder='vits', features=64, use_bn=False, out_channels=[48, 96, 192, 384], use_clstoken=False):
        ...
        self.pretrained = torch.hub.load('D:/jianzhi/ZoeDepthmain/dinov2-main', 'dinov2_{:}14'.format(encoder), source='local', pretrained=False)
    ...
    def forward(self, x):
        ...
        # # 假设 features 是一个元组，包含多个张量
        # # 遍历 features 元组中的每个元素并检查其类型
