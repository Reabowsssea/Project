...
from Unet_attention import U_Net4
...
# train_images2 = r"/root/autodl-tmp/UWAmodel_2/datasets/data_splits_prediction/train"
...
# val_images2 = r'/root/autodl-tmp/UWAmodel_2/datasets/data_splits_prediction/val'
...
# test_images2 = r'/root/autodl-tmp/UWAmodel_2/datasets/data_splits_prediction/test'
...
if __name__ == '__main__':
    ...
    train_datasets = SegmentationDataset(train_images3,train_images4,train_labled, n_classes,  input_class)
    ...
    val_datasets = SegmentationDataset(val_images3, val_images4,val_labeled, n_classes,  input_class)
    ...
    for i, image_name in enumerate(sorted_original_images):
        ...
        if num1 not in [222,152,312,307,280,310]:
            ...
            hist,hist2,pixel_accuracy,mean_accuracy,class_iou,mean_iou,frequency_weighted_iou,label, lbl_pred = \
                predict4(num1,num2,model,input_class,d_path,o_path, o_path, label_image_path,prediction_save_path,prediction_compare_save_path,Multiple_picture_path)
            miou = per_class_iu(hist)
