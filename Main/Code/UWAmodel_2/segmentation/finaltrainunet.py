...
train_images2 = r"D:/jianzhi/UWAmodel_2/datasets/data_splits_pin3/train"
train_images3 = r"D:/jianzhi/UWAmodel_2/datasets/data_splits_depth/train"
train_images4 = r"D:/jianzhi/UWAmodel_2/datasets/data_splits_original/train"
train_labled = r'D:/jianzhi/UWAmodel_2/datasets/data_splits_label/train'

val_images2 = r'D:/jianzhi/UWAmodel_2/datasets/data_splits_pin3/val'
val_images3 = r'D:/jianzhi/UWAmodel_2/datasets/data_splits_depth/val'
val_images4 = r"D:/jianzhi/UWAmodel_2/datasets/data_splits_original/val"
val_labeled = r'D:/jianzhi/UWAmodel_2/datasets/data_splits_label/val'

# test_images2 = r'/root/autodl-tmp/UWAmodel_2/datasets/data_splits_pin3/test'
...
# test_labeled = r'/root/autodl-tmp/UWAmodel_2/datasets/data_splits_label/test'loss

test_images2 = r'D:/jianzhi/UWAmodel_2/datasets/data_splits_pin3/test'
test_images3 = r'D:/jianzhi/UWAmodel_2/datasets/data_splits_depth/test'
test_images4 = r"D:/jianzhi/UWAmodel_2/datasets/data_splits_original/test"
test_labeled = r'D:/jianzhi/UWAmodel_2/datasets/data_splits_label/test'
...
def train_model(train_dataloader, test_dataloader, model, optimizer, num_epochs, scheduler, model_save_path):
    ...
    for epoch in range(num_epochs):
        ...
        if (np.mean(class_miou_array) > best_val_miou) and (epoch > 20):
            ...
            torch.save(model.state_dict(), f'{model_save_path}/MIOU_best_model.pth')
        ...
        if np.all(acc_cls > best_acc_cls):
            ...
            torch.save(model.state_dict(), f'{model_save_path}/MPA_best_model.pth')
        ...
        if np.all(acc_cls > best_acc_cls) and (np.mean(class_miou_array) > best_val_miou) and (epoch > 20):
            torch.save(model.state_dict(), f'{model_save_path}/MPAandMIOU_best_model.pth')
...
if __name__ == '__main__':
    ...
    ux_texm = r"D:/jianzhi/UWAmodel_2/Unet_train_model/logs"
    ...
    model_save_path = fr"D:/jianzhi/UWAmodel_2/Unet_train_model/{formatted_time}"
...
#----------------------------------------测试！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
    # model = torch.load("/root/autodl-tmp/UWAmodel_2/Unet_train_model/2025_04_10_13_07_18/MPA_best_model.pth")#rgb，深度，差分(假的)

    # model = torch.load("/root/autodl-tmp/UWAmodel_2/Unet_train_model/2025_04_10_12_22_31/MPA_best_model.pth")#rgb，深度

    # model = torch.load("/root/autodl-tmp/UWAmodel_2/Unet_train_model/2025_04_10_19_22_58/final_model.pth")#差分和深度。
    # model = torch.load("/root/autodl-tmp/UWAmodel_2/Unet_train_model/2025_04_10_20_00_14/final_model.pth")#差分和rgb。

    # model = torch.load("/root/autodl-tmp/UWAmodel_2/Unet_train_model/2025_04_10_10_09_41/MPA_best_model.pth")#单rgb
    # model = torch.load("/root/autodl-tmp/UWAmodel_2/Unet_train_model/2025_04_10_10_43_39/MPA_best_model.pth")#单深度

    model = torch.load("/root/autodl-tmp/UWAmodel_2/Unet_train_model/2025_04_10_18_37_27/final_model.pth")#真正的rgb, 深度，差分

    model = U_Net4_Modified(in_ch=2, out_ch=3)  # 按照你模型的输入输出做
    state_dict = torch.load("/root/autodl-tmp/UWAmodel_2/Unet_train_model/2025_04_10_18_37_27/final_model.pth",
                            map_location="cuda")
